...
class  rpt_reverso_cheque_santander extends reporte {
	function  rpt_reverso_cheque_santander($sql, $xml, $labels=array(), $titulo, $con_logo, $vuelve_a_presentacion=false) {
	...
	function modifica_pdf(&$pdf) {
		...
		$pdf->SetFont('Arial','',8);
		$pdf->Text(385, -415, "RUT Proveedor: $rut_completo");
		$pdf->Text(385, -405,'Documentos:');
