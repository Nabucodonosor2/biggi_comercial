function change_precio(boton, ve_tabla) {
	...
	if(document.getElementById('AUT_DESCTO_ESP_H_0')){
		var aut_dscto = document.getElementById('AUT_DESCTO_ESP_H_0').value;
		var url = "../common_appl/change_precio.php?tabla="+ve_tabla+"&cod_item="+cod_item+"&cod_producto="+cod_producto+"&precio="+precio+"&aut_dscto="+aut_dscto;
	}else{
