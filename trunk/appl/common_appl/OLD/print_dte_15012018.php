...
switch ($DTE_ORIGEN) {
	...
	if($PORC_DSCTO1 == 0 && $PORC_DSCTO2 == 0){
		...
		$pdf->RoundedRect(155, 171.5+7, 51, 27.5, 3.5);
		$pdf->Line(189,171.5+7,189,206);
		$pdf->SetFont('helvetica','B',6.95);	
