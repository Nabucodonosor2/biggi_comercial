...
switch ($DTE_ORIGEN) {
	...
	/*************TOTALES***********/
	$pdf->RoundedRect(155, 171.5, 51, 27, 3.5);
	$pdf->Line(189,171.5,189,198);
	$pdf->SetFont('helvetica','B',6.95);	
	$pdf->Text(174, 173,"SUBTOTAL");
	$pdf->SetFont('helvetica','',7.15);
	$pdf->SetXY(180, 173);
	...
	$pdf->Line(155,188,206,188);
	$pdf->SetFont('helvetica','B',6.95);
	$pdf->Text(169, 189,"TOTAL EXENTO");
	$pdf->SetFont('helvetica','',7.15);
	$pdf->SetXY(180, 189);
	$pdf->MultiCell(26, 1,number_format($TOTAL_NETO,0,'.','.'),0,"R");
	$pdf->Line(155,193,206,193);
	$pdf->SetFont('helvetica','B',6.95);
	$pdf->Text(179, 194,"TOTAL");
	$pdf->SetFont('helvetica','',7.15);
	$pdf->SetXY(180, 194);
	$pdf->MultiCell(26, 1,number_format($TOTAL_CON_IVA,0,'.','.'),0,"R");
