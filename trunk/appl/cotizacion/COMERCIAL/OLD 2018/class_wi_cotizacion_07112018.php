	...
	*/
	...
	function printcot_cad(){
		...
		$sql = "SELECT ITEM
					  ...
					  ,IC.NOM_PRODUCTO
					  ,CANTIDAD
					  ,CONVERT(VARCHAR, LARGO)+' x '+CONVERT(VARCHAR, ANCHO)+' x '+CONVERT(VARCHAR, ALTO) MEDIDAS
		...
		$worksheet->write(3, 1, "NOM_PRODUCTO", $text_border_all_title);
		$worksheet->write(3, 2, "COD_PRODUCTO", $text_border_all_title);
		$worksheet->write(3, 3, "CANTIDAD", $text_border_all_title);
		$worksheet->write(3, 4, "MEDIDAS", $text_border_all_title);
		$worksheet->write(3, 5, "GRIFERIA", $text_border_all_title);
		$worksheet->write(3, 6, "DESAGUE", $text_border_all_title);
		$worksheet->write(3, 7, "POTENCIA", $text_border_all_title);
		$worksheet->write(3, 8, "VOLTAGE", $text_border_all_title);
		$worksheet->write(3, 9, "POTENCIA", $text_border_all_title);
