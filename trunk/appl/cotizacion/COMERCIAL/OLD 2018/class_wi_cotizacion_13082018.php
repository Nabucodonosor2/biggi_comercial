...
class wi_cotizacion extends wi_cotizacion_base {
	...
	function print_record() {
    	...
    	case "resumen":
       	...
       	break;
       	case "resumen_item":
				$this->print_resumen_item($print_cot[3] == 'logo');
       	break;
    	case "ampliada":
				if($print_cot[2] == 'pdf')
	...
	*/
	function print_resumen_item($con_logo){
		$cod_cotizacion = $this->get_key();
		...
		$rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/cot_resumen_item.xml', $labels, "Cotización Resumen item ".$cod_cotizacion.".pdf", $con_logo);		
	}
