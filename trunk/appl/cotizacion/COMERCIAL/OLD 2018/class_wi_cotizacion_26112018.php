...
class wi_cotizacion extends wi_cotizacion_base {
	...
	*/
	...
	function printcot_cad(){
		...
		$worksheet->write(2, 5, "AGUA", $text_border_all_title);
		$worksheet->write(2, 6, "", $text_border_all_title);
		$worksheet->write(2, 7, "ELECTRICIDAD", $text_border_all_title);
		$worksheet->write(2, 8, "", $text_border_all_title);
		$worksheet->write(2, 9, "GAS", $text_border_all_title);
		
		$worksheet->merge_cells(2, 5, 2, 6);
		$worksheet->merge_cells(2, 7, 2, 8);
		
		$worksheet->write(3, 0, "ITEM", $text_border_all_title);
		$worksheet->write(3, 1, "DESCRIPCION", $text_border_all_title);
		$worksheet->write(3, 2, "MODELO", $text_border_all_title);
		$worksheet->write(3, 3, "CANT.", $text_border_all_title);
		$worksheet->write(3, 4, "FRENTE x PROF x ALTO", $text_border_all_title);
		$worksheet->write(3, 5, "GRIFERIA", $text_border_all_title);
		$worksheet->write(3, 6, "DESAGUE", $text_border_all_title);
		$worksheet->write(3, 7, "CONSUMO Kw/hr", $text_border_all_title);
		$worksheet->write(3, 8, "VOLTAJE", $text_border_all_title);
		$worksheet->write(3, 9, "CONSUMO Kw/hr", $text_border_all_title);
		...
		while($my_row = $db->get_row()){
			...
			$worksheet->write(4+$l, 3, $my_row['CANTIDAD'], $text_border_all_right);
