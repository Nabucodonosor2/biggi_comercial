...
function printcot_ampliada_pdf_test($con_logo) {
	...
	$sql = "SELECT			C.COD_COTIZACION,
		...
		$pdf->setPrintHeader(false);//PARA EVITAR QUE SE DIBUJE UNA LINEA EN LA CABECERA DEBE IR SIEMPRE ANTES DE {AddPage}
    	$pdf->setPrintFooter(false);//PARA EVITAR QUE SE DIBUJE UNA LINEA EN EL PIE DE PAGINA DEBE IR SIEMPRE ANTES DE {AddPage}
		$pdf->AddPage();
    	$pdf->SetCreator('');
		...
		$pdf->Image($imagen_fondo,0,-9,612,792);
		

		$pdf->SetTextColor(0,0,0);
	    $pdf->SetFont('helvetica','',9);	
		$pdf->Text(258, 21,utf8_encode('Comercial Biggi (Chile) S.A.'));
		$pdf->Text(258, 33,utf8_encode('Av. Portugal 1726, Santiago - Chile'));
		$pdf->Text(258, 45,utf8_encode('Fono: 56 224126200 - info@biggi.cl'));
		
		$pdf->SetTextColor(0,0,127);
		$pdf->SetFont('helvetica','',13);	
		$pdf->Text(258, 61,utf8_encode('www.biggi.cl'));

		$pdf->SetTextColor(0,0,127);
	    $pdf->SetFont('helvetica','B',15);	
		$pdf->Text(475, 21,utf8_encode('Cotización'));
		$pdf->Text(475, 38,utf8_encode('Nº '.$cod_cotizacion));
		...
		$pdf->Text(30, 99,utf8_encode('Señores:'));
		$pdf->SetTextColor(0,0,0);
		$pdf->SetFont('helvetica','',9);	
		$pdf->SetXY(30, 114);
		...
		$pdf->Text(30, 156,utf8_encode('Rut:'));
		$pdf->SetFont('helvetica','',9);
		...
		$pdf->SetTextColor(0,0,127);//AZUL RE
		$pdf->SetFont('helvetica','B',10);
		$pdf->Text(30, 177,utf8_encode('Referencia:'));
		$pdf->SetFont('helvetica','',10);
		$pdf->SetTextColor(0,0,0);//NEGRO RE
		$pdf->Text(92, 177,utf8_encode($result[0]['REFERENCIA']));

		$pdf->SetTextColor(0,0,127);//AZUL RE
		$pdf->SetFont('helvetica','B',10);
		$pdf->Text(517, 177,utf8_encode('Vendedor:'));
		$pdf->SetTextColor(0,0,0);//AZUL RE
		$pdf->SetFont('helvetica','',10);
		$pdf->SetXY(566, 175);
		$pdf->Cell(29, 17,utf8_encode('CA'),0,0,'R');
