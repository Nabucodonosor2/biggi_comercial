...
class wi_cotizacion extends wi_cotizacion_base {
	...
	*/
	...
	function printcot_resumen_pdf_test($con_logo) {
		...
		$labels = array();
		$labels['strCOD_COTIZACION'] = $cod_cotizacion;
		$rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/cot_resumen_test.xml', $labels, "Cotización Resumen ".$cod_cotizacion.".pdf", $con_logo);
	}
	...
	$sql = "SELECT			C.COD_COTIZACION,
		...
		$labels = array();
		$labels['strCOD_COTIZACION'] = $cod_cotizacion;
		$rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/cot_ampliado_test.xml', $labels, "Cotización Ampliada ".$cod_cotizacion.".pdf", $con_logo);
	}
