...
class wi_cotizacion extends wi_cotizacion_base {
	...
	*/
	...
	function printcot_cad(){
		...
		$worksheet->write(2, 5, "AGUA", $text_border_all_title_bold);
		$worksheet->write(2, 6, "", $text_border_all_title_bold);
		$worksheet->write(2, 7, "ELECTRICIDAD", $text_border_all_title_bold);
		$worksheet->write(2, 8, "", $text_border_all_title_bold);
		$worksheet->write(2, 9, "GAS", $text_border_all_title_bold);
		
		$worksheet->merge_cells(2, 5, 2, 6);
		$worksheet->merge_cells(2, 7, 2, 8);
		
		$worksheet->write(3, 0, "ITEM", $text_border_all_title_bold);
		$worksheet->write(3, 1, "DESCRIPCION", $text_border_all_title_bold);
		$worksheet->write(3, 2, "MODELO", $text_border_all_title_bold);
		$worksheet->write(3, 3, "FRENTE x PROF x ALTO", $text_border_all_title_bold);
		$worksheet->write(3, 4, "CANT.", $text_border_all_title_bold);
		$worksheet->write(3, 5, "GRIFERIA", $text_border_all_title_bold);
		$worksheet->write(3, 6, "DESAGUE", $text_border_all_title_bold);
		$worksheet->write(3, 7, "CONSUMO Kw/hr", $text_border_all_title_bold);
		$worksheet->write(3, 8, "VOLTAJE", $text_border_all_title_bold);
		$worksheet->write(3, 9, "CONSUMO Kw/hr", $text_border_all_title_bold);
		
		$l = 0;
		while($my_row = $db->get_row()){
			if($my_row['COD_PRODUCTO'] == 'T'){
				$worksheet->write(4+$l, 0, $my_row['ITEM'], $text_border_all_title_bold);
				$worksheet->write(4+$l, 1, $my_row['NOM_PRODUCTO'], $text_border_all_title2);
				$worksheet->write(4+$l, 2, "", $text_border_all_left);
				$worksheet->write(4+$l, 3, "", $text_border_all_center);
				$worksheet->write(4+$l, 4, "", $text_border_all_right);
				$worksheet->write(4+$l, 5, "", $text_border_all_center);
				...
				$worksheet->write(4+$l, 0, $my_row['ITEM'], $text_border_all_center);
				$worksheet->write(4+$l, 1, $my_row['NOM_PRODUCTO'], $text_border_all_left);
			}
			
			$worksheet->write(4+$l, 2, $my_row['COD_PRODUCTO'], $text_border_all_left);
			$worksheet->write(4+$l, 3, $my_row['MEDIDAS'], $text_border_all_center);
			$worksheet->write(4+$l, 4, $my_row['CANTIDAD'], $text_border_all_right);
			...
			$worksheet->write(4+$l, 5, $GRIFERIA, $text_border_all_center);
			$worksheet->write(4+$l, 6, $DESAGUE, $text_border_all_center);
			$worksheet->write(4+$l, 7, $POTENCIA, $text_border_all_center);
			$worksheet->write(4+$l, 8, $VOLTAJE, $text_border_all_center);
			$worksheet->write(4+$l, 9, $POTENCIA_KW, $text_border_all_center);
			$l++;
		}
