...
class wi_cotizacion extends wi_cotizacion_base {
    ...
    function print_folleto($tipo_print){
        ...
        for($i=0 ; $i < count($result) ; $i++)
            ...
            print "<script>window.open('print_especial.php?RESULT_PRODUCTO=$lista_productos&TIPO_PRINT=$tipo_print&COD=$cod_cotizacion')</script>";
            $this->_load_record();
    }
    ...
    function print_record() {
        ...
        if($os == 'IPAD' ){
            ...
            $imprimer_logo_wp = $_POST['wi_hidden_logo_wp'];
        }
        $this->imprime_logo_wp = $imprimer_logo_wp;
        ...
        switch ($print_cot[0]) {
            ...
            case "res_int":
                ...
                break;
            case "tecnica":
                $lista_tecnica = explode("X", $print_cot[1]);
                ...
                break;
            case "test_resumen":
                $this->printcot_resumen_pdf_test('logo',$print_cot[1]);
                
                break;
            case "test_ampliada":
                $this->printcot_ampliada_pdf_test('logo',$print_cot[1]);
    ...
    function print_resumen_item($con_logo, $print_especial){
        ...
        if($print_especial == 'S')
            $xml = $this->root_dir.'appl/cotizacion/cot_resumen_item_esp.xml';
                ...
                $rpt= new reporte($sql, $xml, $labels, "RESUMEN ITEMS COTIZACION ".$cod_cotizacion.".pdf", $con_logo);
    }
    ...
    function printcot_resumen_pdf($con_logo) {
        ...
        $labels = array();
        $labels['strCOD_COTIZACION'] = $cod_cotizacion;
        $rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/cot_resumen.xml', $labels, "COTIZACION RESUMEN ".$cod_cotizacion.".pdf", $con_logo);
    }
    
    function printcot_resumen_pdf_test($con_logo,$tipoDescuento) {
        $cod_cotizacion = $this->get_key();
        $TIPO_COT = 'RESUMEN_PDF';
        $logo_wp = $this->imprime_logo_wp;
        $COD_USUARIO = session::get("COD_USUARIO");
        print " <script>window.open('COMERCIAL/print_cotizacion.php?TIPO_COT=$TIPO_COT&COD_COTIZACION=$cod_cotizacion&TIPO_DESC=$tipoDescuento&webpay_logo=$logo_wp&cu=$COD_USUARIO')</script>";
        
        $this->_load_record();
    }
    
    function printcot_ampliada_pdf_test($con_logo,$tipoDescuento) {
        $cod_cotizacion = $this->get_key();
        $TIPO_COT = 'AMPLIADA_PDF';
        $logo_wp = $this->imprime_logo_wp;
        $COD_USUARIO = session::get("COD_USUARIO");
        print " <script>window.open('COMERCIAL/print_cotizacion.php?TIPO_COT=$TIPO_COT&COD_COTIZACION=$cod_cotizacion&TIPO_DESC=$tipoDescuento&webpay_logo=$logo_wp&cu=$COD_USUARIO')</script>";
    ...
    function printcot_ampliada_pdf($con_logo) {
        ...
        $labels = array();
        $labels['strCOD_COTIZACION'] = $cod_cotizacion;
        $rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/cot_ampliado.xml', $labels, "COTIZACION AMPLIADA ".$cod_cotizacion.".pdf", $con_logo);
    }
    ...
    function printcot_pesomedida_pdf($con_logo, $embalada) {
        ...
        $labels = array();
        $labels['strCOD_COTIZACION'] = $cod_cotizacion;
        $rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/pesos_medidas.xml', $labels, "$NOM_DOC.pdf", $con_logo);
    }
    ...
    function printcot_tecnica_electrico_pdf($con_logo) {
        ...
        $labels = array();
        $labels['strCOD_COTIZACION'] = $cod_cotizacion;
        $rpt = new reporte($sql, $this->root_dir.'appl/cotizacion/list_elect.xml', $labels, "LISTA TECNICA ELECTRICO COTIZACION ".$cod_cotizacion.".pdf", $con_logo);
    }
    function printcot_tecnica_gas_pdf($con_logo, $con_total_consumo) {
        ...
        $rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/list_gas.xml', $labels, "LISTA TECNICA GAS COTIZACION  ".$cod_cotizacion.".pdf", $con_logo);
    ...
    function printcot_tecnica_vapor_pdf($con_logo) {
        ...
        $labels = array();
        $labels['strCOD_COTIZACION'] = $cod_cotizacion;
        $rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/list_vapor.xml', $labels, "LISTA TECNICA VAPOR COTIZACION ".$cod_cotizacion.".pdf", $con_logo);
    ...
    function printcot_tecnica_agua_pdf($con_logo) {
        ...
        $labels = array();
        $labels['strCOD_COTIZACION'] = $cod_cotizacion;
        $rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/list_agua.xml', $labels, "LISTA TECNICA AGUA COTIZACION ".$cod_cotizacion.".pdf", $con_logo);
    }
    function printcot_tecnica_ventilacion_pdf($con_logo) {
        ...
        $labels = array();
        $labels['strCOD_COTIZACION'] = $cod_cotizacion;
        $rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/list_ventilacion.xml', $labels, "LISTA TECNICA VENTILACION COTIZACION ".$cod_cotizacion.".pdf", $con_logo);
    }
    function printcot_tecnica_desague_pdf($con_logo) {
        ...
        $labels = array();
        $labels['strCOD_COTIZACION'] = $cod_cotizacion;
        $rpt= new reporte($sql, $this->root_dir.'appl/cotizacion/list_desague.xml', $labels, "LISTA TECNICA DESAGUE COTIZACION ".$cod_cotizacion.".pdf", $con_logo);
    }
    // EXCEL
    ...
    function printcot_ampliada_excel($con_logo){
        ...
        header("Content-Type: application/x-msexcel; name=\"COTIZACION AMPLIADA $COD_COTIZACION.xls\"");
        header("Content-Disposition: inline; filename=\"COTIZACION AMPLIADA $COD_COTIZACION.xls\"");
        $fh=fopen($fname, "rb");
        fpassthru($fh);
        unlink($fname);
    ...
    function printcot_pesomedida_excel($con_logo, $embalada) {
        ...
        header("Content-Type: application/x-msexcel; name=\"$NOM_DOC.xls\"");
        header("Content-Disposition: inline; filename=\"$NOM_DOC.xls\"");
        $fh=fopen($fname, "rb");
        fpassthru($fh);
        unlink($fname);
    ...
    function printcot_tecnica_electrico_excel($con_logo) {
        ...
        header("Content-Type: application/x-msexcel; name=\"LISTA TECNICA ELECTRICO $COD_COTIZACION.xls\"");
        header("Content-Disposition: inline; filename=\"LISTA TECNICA ELECTRICO $COD_COTIZACION.xls\"");
        $fh=fopen($fname, "rb");
        fpassthru($fh);
        unlink($fname);
    ...
    function printcot_tecnica_gas_excel($con_logo, $con_total_consumo) {
        ...
        header("Content-Type: application/x-msexcel; name=\"LISTA TECNICA GAS $COD_COTIZACION.xls\"");
        header("Content-Disposition: inline; filename=\"LISTA TECNICA GAS $COD_COTIZACION.xls\"");
        $fh=fopen($fname, "rb");
        fpassthru($fh);
        unlink($fname);
    ...
    function printcot_tecnica_vapor_excel($con_logo) {
        ...
        header("Content-Type: application/x-msexcel; name=\"LISTA TECNICA VAPOR $COD_COTIZACION.xls\"");
        header("Content-Disposition: inline; filename=\"LISTA TECNICA VAPOR $COD_COTIZACION.xls\"");
        $fh=fopen($fname, "rb");
        fpassthru($fh);
        unlink($fname);
    ...
    function printcot_tecnica_agua_excel($con_logo) {
        ...
        header("Content-Type: application/x-msexcel; name=\"LISTA TECNICA AGUA $COD_COTIZACION.xls\"");
        header("Content-Disposition: inline; filename=\"LISTA TECNICA AGUA $COD_COTIZACION.xls\"");
        $fh=fopen($fname, "rb");
        fpassthru($fh);
        unlink($fname);
    ...
    function printcot_tecnica_ventilacion_excel($con_logo) {
        ...
        header("Content-Type: application/x-msexcel; name=\"LISTA TECNICA VENTILACION $COD_COTIZACION.xls\"");
        header("Content-Disposition: inline; filename=\"LISTA TECNICA VENTILACION $COD_COTIZACION.xls\"");
        $fh=fopen($fname, "rb");
        fpassthru($fh);
        unlink($fname);
    ...
    function printcot_tecnica_desague_excel($con_logo) {
        ...
        header("Content-Type: application/x-msexcel; name=\"LISTA TECNICA DESAGUE $COD_COTIZACION.xls\"");
        header("Content-Disposition: inline; filename=\"LISTA TECNICA DESAGUE $COD_COTIZACION.xls\"");
        $fh=fopen($fname, "rb");
        fpassthru($fh);
        unlink($fname);
