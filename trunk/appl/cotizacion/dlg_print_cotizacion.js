...
function get_returnVal() {
	...
	*/
	...
	if(document.getElementById('resumen').checked && document.getElementById('ch_excel').checked){
		res = 'resumen||excel|logo||';
		
	}
	if(document.getElementById('ampliada').checked  && document.getElementById('ch_excel').checked){
		res = "ampliada||excel|logo||";
	}
	...
	if(document.getElementById('resumen').checked && document.getElementById('item').checked 
			&& document.getElementById('MUESTRA_0').value == 'SI' && document.getElementById('ch_pdf').checked){
		res = "test_resumen|DSCTO_ITEM";

	}
	if(document.getElementById('resumen').checked && document.getElementById('descuento').checked 
			&& document.getElementById('MUESTRA_0').value == 'SI' && document.getElementById('ch_pdf').checked){
		res = 'test_resumen|DSCTO_TOTAL';
		
	}
	if(document.getElementById('ampliada').checked && document.getElementById('item').checked 
			&& document.getElementById('MUESTRA_0').value == 'SI' && document.getElementById('ch_pdf').checked){
		res = "test_ampliada|DSCTO_ITEM";
	}
	if(document.getElementById('ampliada').checked && document.getElementById('descuento').checked 
			&& document.getElementById('MUESTRA_0').value == 'SI' && document.getElementById('ch_pdf').checked){
		res = 'test_ampliada|DSCTO_TOTAL';
	}
	if(document.getElementById('ch_webpay').checked){
		res = res+'&S';
	}else{
		res = res+'&N';
	}
