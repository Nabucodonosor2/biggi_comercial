...
$temp->setVar("MUESTRA", '<input class="input_text" name="MUESTRA_0" id="MUESTRA_0" type="hidden" value="'.$muestra_descto.'" size="100" maxlength="100" onblur="this.style.borderColor = this.style.borderWidth = this.style.borderStyle = \'\';" onfocus="this.style.border=\'1px solid #FF0000\'">');
	
if($autoriza == 'E')
	$input = '<input name="formato" type="radio" onclick="valida_descuento('."'$muestra_descto'".');" id="ch_excel" value="1">Excel';
else
	$input = '<input name="formato" type="radio" onclick="valida_descuento('."'$muestra_descto'".');" id="ch_excel" value="1">Excel';
