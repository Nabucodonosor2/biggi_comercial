...
if($respuesta == ''){
  ...
  $respuesta .=  $result_final[0]['COD_NOTA_VENTA']."|";
  $respuesta .=  $result_final[0]['RAZON_SOCIAL']."|";
  ...
  $respuesta .=  $result_final[0]['RAZON_SOCIAL_I']."|";
  $respuesta .=  $result_final[0]['COD_EMPRESA']."|";
  $respuesta .=  $result_final[0]['MONTO_DOC_T'];
}
