...
$db = new database(K_TIPO_BD, K_SERVER, K_BD, K_USER, K_PASS);
	...
	//No revisaba en la tabla ENVIO_SOFTLAND por si sola... cuando es factura venta la tabla ENVIO_FACTURA no pobla el campo nro_comprobante MH 11-11-2021
	$sql = "select top 1 COD_ENVIO_SOFTLAND
		from ENVIO_SOFTLAND
		where NRO_COMPROBANTE = $nro_comprobante
		  and COD_ESTADO_ENVIO = $K_ENVIO_CONFIRMADO  
		  and year(FECHA_ENVIO_SOFTLAND) = year(getdate())";  
