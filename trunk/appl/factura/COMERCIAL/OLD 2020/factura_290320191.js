function pinta_salida(){
	if(document.getElementById('GENERA_SALIDA_0').checked){
		...
		document.getElementById('msj_salida').innerHTML = 'FACTURA PERMITE DEPACHAR EQUIPOS'
	}else{
		document.getElementById('tdGSalida').className = "oscuro B-ROJO";
		document.getElementById('msj_salida').innerHTML = 'FACTURA NO PERMITE DEPACHAR EQUIPOS'
	}
}
