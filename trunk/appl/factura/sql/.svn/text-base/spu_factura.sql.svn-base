...
BEGIN  
        declare        @kl_cod_estado_fa_emitida numeric,
                ...
                ,@vl_centro_costo_cliente	numeric
                ,@vl_count numeric
        ...
        if (@ve_operacion='UPDATE')
            begin
                select    @vl_cod_usuario_anula = f.cod_usuario_anula,
                        ...
                        @vl_centro_costo_cliente = f.centro_costo_cliente
                ...
                if(@vl_centro_costo_cliente <> @ve_centro_costo_cliente and @vl_count > 0)begin
	                UPDATE REFERENCIA
            ...
            begin
                ...
                begin
                    declare @vl_nro_factura_rental	numeric  
                                ...
                                begin
                                    ...
                                    if(@vl_count > 0)
                                        begin
                                            ...
                                            where    cod_estado_doc_sii = @kl_cod_estado_fa_enviada
                                            and        porc_iva = 0
                                            and cod_factura not in (24808, 24316)

											select   @vl_nro_factura_rental=  max(nro_factura) + 1
											from    rental.dbo.factura
											where    cod_estado_doc_sii = @kl_cod_estado_fa_enviada
											and        porc_iva = 0
											
											if (@vl_nro_factura_rental > @vl_nro_factura)
												set @vl_nro_factura  = @vl_nro_factura_rental
												
											if(@vl_nro_factura in(62117,8910))begin
												set @vl_nro_factura = @vl_nro_factura + 1
											end 
                ...
                begin
                    ...
                    select ipf.cod_ingreso_pago_factura
                        ,ipf.cod_ingreso_pago
                        ,ipf.monto_asignado
                    from ingreso_pago_factura ipf, INGRESO_PAGO ip
                    where ipf.tipo_doc = 'NOTA_VENTA'
                        and ipf.cod_doc = @vl_cod_doc
                    ...
                    WHILE @@FETCH_STATUS = 0 BEGIN                                
						...
						/*
						VMC+MH 17-12-2014, no se borra la linea de la NV para dejar un rastro de auditoria
