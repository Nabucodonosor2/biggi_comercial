...
class wo_faprov extends w_output {
	...
	const K_PARAM_DIRECTORIO = 31;
   	...
   	function wo_faprov() {
		...
		$sql = "SELECT   F.COD_FAPROV
   		...
   		parent::w_output('faprov', $sql, $_REQUEST['cod_item_menu']);
		...
		$this->add_header(new header_date('FECHA_REGISTRO', 'FECHA_REGISTRO', 'Fecha'));
	...
	function asignar($cod_cuenta_compra) {
