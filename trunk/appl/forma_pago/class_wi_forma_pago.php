...
class wi_forma_pago extends w_input {
	function wi_forma_pago($cod_item_menu) {
		...
		$sql = "SELECT 1 FORMA_PAGO_SII
					  ,'CONTADO' NOM_FORMA_PAGO_SII
				UNION
				SELECT 2 FORMA_PAGO_SII
					  ,'CRÉDITO' NOM_FORMA_PAGO_SII";
		
		$this->dws['dw_forma_pago']->add_control(new drop_down_dw('FORMA_PAGO_SII',$sql,180));
	...
	function save_record($db) {
		...
		$FORMA_PAGO_SII = $this->dws['dw_forma_pago']->get_item(0, 'FORMA_PAGO_SII');
		
		$COD_FORMA_PAGO = ($COD_FORMA_PAGO=='') ? "null" : $COD_FORMA_PAGO;
		$FORMA_PAGO_SII = ($FORMA_PAGO_SII=='') ? "null" : $FORMA_PAGO_SII;		
	    ...
	    $param	= "'$operacion', $COD_FORMA_PAGO, '$NOM_FORMA_PAGO', $ORDEN, $CANTIDAD_DOC, $FORMA_PAGO_SII"; 
