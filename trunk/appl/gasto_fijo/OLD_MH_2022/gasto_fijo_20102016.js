...
function crear_gf(){
	var args = "location:no;dialogLeft:300px;dialogTop:150px;dialogWidth:730px;dialogHeight:230px;dialogLocation:0;Toolbar:no;";
	var returnVal = window.showModalDialog("dlg_crear_gf.php", "_blank", args);
	if (returnVal == null)		
		return false;		
	else{
