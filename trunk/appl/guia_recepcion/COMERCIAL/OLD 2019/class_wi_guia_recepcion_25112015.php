...
class wi_guia_recepcion extends wi_guia_recepcion_base {
	...
	function envia_mail($db, $COD_GUIA_RECEPCION){
		...
		$mailcc = array('ascianca@biggi.cl', 'sergio.pechoante@biggi.cl', 'rescudero@biggi.cl', 'kverdugo@biggi.cl');
		$mailccname = array('ANGEL SCIANCA','SERGIO PECHOANTE','RAFAEL ESCUDERO','KARINA VERDUGO');
