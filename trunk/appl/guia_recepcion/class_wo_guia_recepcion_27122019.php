...
class wo_guia_recepcion extends w_output_biggi{
   	function wo_guia_recepcion(){
		...
		$this->add_header(new header_text('COD_NOTA_VENTA', "dbo.f_get_nro_nota_venta(GR.COD_DOC, GR.TIPO_DOC, GR.COD_GUIA_RECEPCION, 'S')", 'Nº NV'));
		$this->add_header(new header_text('MODELO_GR', "dbo.f_get_modelo_gr(GR.COD_GUIA_RECEPCION)", 'Modelo'));
   	}
