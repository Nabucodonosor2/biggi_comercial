...
$dw->add_control(new edit_radio_button('PRINT_NORMAL', 'S', 'N', '  IMPRESION NORMAL', 'TIPO'));
$dw->add_control(new edit_radio_button('PRINT_SECUNDARIO', 'N', 'N', '  IMPRESION ANEXO (NO USAR)', 'TIPO'));
$dw->insert_row();
