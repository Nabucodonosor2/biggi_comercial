...
class wi_inf_bodega_stock_base extends w_param_informe_biggi {
	
	function wi_inf_bodega_stock_base($cod_item_menu) {
		$xml = session::get('K_ROOT_DIR').'appl/inf_bodega_stock/inf_bodega_stock.xml';
		parent::w_param_informe_biggi('inf_bodega_stock', $cod_item_menu, 'Inventario Valorizado Sala Venta.pdf', $xml, '', 'spi_bodega_stock');
...
$file_name = dirname(__FILE__)."/".K_CLIENTE."/class_wi_inf_bodega_stock.php";
