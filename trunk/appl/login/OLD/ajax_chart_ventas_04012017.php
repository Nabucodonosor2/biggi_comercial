...
$sql="SELECT dbo.f_chart_ventas(2013, 1) ENE_2013
	  		,dbo.f_chart_ventas(2013, 2) FEB_2013
	  		,dbo.f_chart_ventas(2013, 3) MAR_2013
			,dbo.f_chart_ventas(2013, 4) ABR_2013
			,dbo.f_chart_ventas(2013, 5) MAY_2013
			,dbo.f_chart_ventas(2013, 6) JUN_2013
			,dbo.f_chart_ventas(2013, 7) JUL_2013
			,dbo.f_chart_ventas(2013, 8) AGO_2013
			,dbo.f_chart_ventas(2013, 9) SEP_2013
			,dbo.f_chart_ventas(2013, 10) OCT_2013
			,dbo.f_chart_ventas(2013, 11) NOV_2013
			,dbo.f_chart_ventas(2013, 12) DIC_2013
			,dbo.f_chart_ventas(2014, 1) ENE_2014
