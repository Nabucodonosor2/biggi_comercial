<?php
	...
	for($i=0;$i < count($sql_cod_vendedor); $i++) {
		...
		//$para .= 'ascianca@biggi.cl, sergio.pechoante@biggi.cl, rescudero@biggi.cl, jcatalan@biggi.cl';
		$para .= 'ascianca@biggi.cl, sergio.pechoante@biggi.cl, jcatalan@biggi.cl';
	...
	/// Inicio MH regulariza el 24/06/2013
		...
		$mail->AddBCC('evergara@integrasystem.cl', 'Erick');
