...
class wi_nota_credito_base extends w_cot_nv {
	...
	function enviar_dte(){
		...
		if(($COD_ESTADO_LIBRE_DTE_FA == 0) || ($COD_ESTADO_LIBRE_DTE_FA == 4) || ($COD_ESTADO_LIBRE_DTE_FA == 5) || ($COD_ESTADO_LIBRE_DTE_FA == 6) || ($COD_ESTADO_LIBRE_DTE_FA == 7) || ($COD_ESTADO_LIBRE_DTE_FA == 8) || ($COD_ESTADO_LIBRE_DTE_FA == 100)){
			$this->_load_record();
