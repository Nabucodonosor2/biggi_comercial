        ...
        if (!$this->lock_record())
            ...
            if($result[0]['NRO_NOTA_CREDITO'] <> '' && $reenviar == false)
				...
				WHERE F.COD_FACTURA = $COD_FACTURA";
                        ...
                        if($revision_estado <> 'EPR' && $revision_estado <> 'RPR' && $revision_estado <> 'RLV' && $COD_FACTURA > 36308){//ultima factura signature cod_factura 36308
                            $this->_load_record();
				...
				AND C.COD_COMUNA = N.COD_COMUNA";
                        ...
                        $a['Encabezado']['IdDoc']['Folio']			= substr($nro_nota_credito, 0, 10);
