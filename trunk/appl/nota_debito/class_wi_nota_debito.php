...
class wi_nota_debito_base extends w_cot_nv {
	...
	function envia_ND_electronica(){
		...
		if ($db->EXECUTE_SP($sp, $param)){
			...
			fwrite($handle, space('', 1));
			fwrite($handle, "\r\n");
			fwrite($handle, space('Tipo Impresión'));//No va
			fwrite($handle, space('', 1));
			fwrite($handle, "\r\n");
			...
			fwrite($handle, "\r\n");
			fwrite($handle, space('Forma de Pago Exportación'));//No va
			fwrite($handle, space('', 2));
			fwrite($handle, "\r\n");
			fwrite($handle, space('Fecha de Cancelación'));//Preguntar a MH
			fwrite($handle, "\r\n");
			...
			fwrite($handle, "\r\n");
			fwrite($handle, space('Días del Termino de Pago'));//Preguntar a MH
			fwrite($handle, "\r\n");
