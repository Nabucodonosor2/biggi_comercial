...
class wi_nota_venta extends w_cot_nv {
	...
	order by INV.ORDEN asc";
		...
		$this->dws['dw_nota_venta']->set_computed('PORC_RESULTADO', '[RESULTADO] / ([TOTAL_NETO] - [STATIC_MONTO_DSCTO_CORPORATIVO]) * 100');
		$this->dws['dw_nota_venta']->set_computed('STATIC_PORC_RESULTADO', '[RESULTADO] / ([TOTAL_NETO] - [STATIC_MONTO_DSCTO_CORPORATIVO]) * 100');
