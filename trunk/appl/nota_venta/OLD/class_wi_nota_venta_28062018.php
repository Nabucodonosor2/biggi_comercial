...
class wi_nota_venta extends w_cot_nv {
	...
	order by INV.ORDEN asc";
		...
		$this->dws['dw_nota_venta']->set_computed('VENTA_NETA_FINAL', '[TOTAL_NETO] - [SUMA_NC] - [MONTO_DSCTO_CORPORATIVO]');	
		...
		$this->dws['dw_nota_venta']->set_computed('RESULTADO', '[TOTAL_NETO] - [SUM_OC_TOTAL_NETA] - [MONTO_GASTO_FIJO] - [MONTO_DSCTO_CORPORATIVO] - [SUMA_NC]');
		$this->dws['dw_nota_venta']->set_computed('STATIC_RESULTADO', '[TOTAL_NETO] - [SUM_OC_TOTAL_NETA] - [MONTO_GASTO_FIJO] - [MONTO_DSCTO_CORPORATIVO] - [SUMA_NC]');	
