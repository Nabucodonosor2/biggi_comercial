...
class static_link_rojo extends static_text {
    var	$href;
...
class dw_lista_guia_despacho_demo extends datawindow {
    ...
    function dw_lista_guia_despacho_demo() {
        $sql = "select convert(varchar, NRO_GUIA_DESPACHO)+'|'+convert(varchar, COD_GUIA_DESPACHO) NRO_GUIA_DESPACHO_DEMO
				from   GUIA_DESPACHO
				where  COD_DOC = {KEY1}
        ...
        $this->add_control(new static_link_rojo('NRO_GUIA_DESPACHO_DEMO', '../../../../commonlib/trunk/php/link_wi.php?modulo_origen=nota_venta&modulo_destino=guia_despacho&cod_modulo_destino=[NRO_GUIA_DESPACHO]&cod_item_menu=1525'));
    }
    function fill_record(&$temp, $record) {
        parent::fill_record($temp, $record);
        if ($record < $this->row_count() - 1)
