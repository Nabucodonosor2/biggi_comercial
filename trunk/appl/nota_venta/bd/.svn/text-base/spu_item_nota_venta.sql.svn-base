...
BEGIN
	...
	else if(@ve_operacion='SRVS_ITNV_WS')
	begin
		execute dbo.spu_item_nota_venta 'INSERT', @ve_cod_item_nota_venta, @ve_cod_nota_venta,@ve_orden,@ve_item,@ve_cod_producto,@ve_nom_producto,@ve_cantidad,@ve_precio
	
		execute dbo.spu_nota_venta 'RECALCULA', @ve_cod_nota_venta
