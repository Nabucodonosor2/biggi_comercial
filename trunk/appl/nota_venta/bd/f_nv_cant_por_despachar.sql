...
--	if (@vl_cod_nota_venta < 62673 or @vl_cod_nota_venta = 56153)	--anteriores al 2013 se asumen despachadas
--	if (@vl_cod_nota_venta < 67611)	--VMC 10-12-2014, anteriores a NV 67611 se asumen despachadas
	if (@vl_cod_nota_venta < 70795)	--VMC 25-11-2014, anteriores a NV 70795 se asumen despachadas
	--**********
		return 0
	...
	if (@vl_cod_nota_venta in (52022,52024,52026,52041,52048,52069,52071,52105,52124,52163,52164,52183,52198,52199,52252,52273,52105,52083, 59887, 59888, 60546, 70149, 68481, 68510))
		return 0
	...
	declare c_cursor_gd cursor static for 
	...
	declare c_cursor_fa cursor static for 
