...
class dw_pago_dir_faprov_faprov extends dw_pago_faprov_faprov{
	function dw_pago_dir_faprov_faprov(){
		parent::dw_pago_faprov_faprov();
...
class wi_pago_directorio extends wi_pago_faprov{
	...
	function wi_pago_directorio ($cod_item_menu){
		...
		$this->dws['dw_pago_faprov_faprov'] = new dw_pago_dir_faprov_faprov();
