...
function dlg_usar_nc(){
	...
	var url = "dlg_usar_nc.php?cod_pago_faprov="+vl_cod_pago_faprov+"&cod_empresa="+vl_cod_empresa+"&cod_nc_prov="+vl_cod_nc_prov;
	$.showModalDialog({
		 url: url,
		 dialogArguments: '',
		 height: 330,
		 ...
		 onClose: function(){ 
		 	...
		 	if (returnVal !=  null){		
				...
				asignacion_monto(document.getElementById('SELECCION_0'));
			}
		}
	});		
}
...
function dlg_empresa_cta_corriente(){
	var url = "dlg_empresa_cta_corriente.php";
	$.showModalDialog({
		 url: url,
		 dialogArguments: '',
		 height: 360,
...
function dlg_empresa_cta_corriente2(){
	var url = "dlg_empresa_cta_corriente.php";
	$.showModalDialog({
		 url: url,
		 dialogArguments: '',
