...
class dw_opciones_especiales extends datawindow {
	function dw_opciones_especiales(){
		...
		$sql = "SELECT COD_PERFIL COD_PERFIL_ACTUAL
				FROM USUARIO
				WHERE COD_USUARIO = $COD_USUARIO";
		$result = $db->build_results($sql);
		$COD_PERFIl_ACTUAL = $result[0]['COD_PERFIL_ACTUAL'];
		...
		$sql = "SELECT			I.COD_ITEM_MENU,
										...
										A.IMPRESION,
										$COD_PERFIl_ACTUAL COD_PERFIL_ACTUAL,
		...
		$this->set_protect('AUTORIZA', "[COD_ITEM_MENU] == 990545 && [COD_PERFIL_ACTUAL] <> 1");				
	}	
