------------------f_get_costo_base_pi----------------
create function f_get_costo_base_pi(@vc_cod_producto varchar(30))
RETURNS numeric(10,2) 
AS
BEGIN
		declare 
			@vl_precio_x_factor(10,2) numeric,
			@vl_dolar numeric(10,2),
			@vl_factor_venta_int numeric(10,2),
			@vl_costo_base_pi	numeric(10,2),
		...
		SELECT  @vl_costo_base_pi = @vl_precio_x_factor * @vl_dolar
	
		return @vl_costo_base_pi;
END
go