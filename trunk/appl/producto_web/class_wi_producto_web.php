...
class wi_producto_web extends w_input{
	...
	function wi_producto_web($cod_item_menu){
		...
		$sql = "select   P.COD_PRODUCTO
			            ...
			            ,NOM_PRODUCTOT3
			            ,USA_FOTO_ANTIGUA
			            ,USA_FOTO_ANTIGUA USA_FOTO_NUEVA
			            ,POTENCIA_KW
        from   			PRODUCTO P
        				,TIPO_PRODUCTO TP
		...
		$this->dws['dw_producto_web']->add_control($control = new edit_radio_button('USA_FOTO_ANTIGUA', 'S', 'N', 'Si', 'TIPO_FOTO'));
		$control->set_onChange("ajuste_valores_foto();");
		$this->dws['dw_producto_web']->add_control($control = new edit_radio_button('USA_FOTO_NUEVA', 'N', 'S', 'No', 'TIPO_FOTO'));
		$control->set_onChange("ajuste_valores_foto();");
		...
		$this->dws['dw_producto_web']->add_control(new edit_num('POTENCIA', 16, 16, 2));
		// VMC, 17-08-2011 se deja no ingresable por solicitud de JJ a traves de MH 
		$this->dws['dw_producto_web']->add_control(new edit_num('CONSUMO_GAS', 16, 16, 2));
		...
		$this->dws['dw_producto_web']->add_control(new edit_num('POTENCIA_KW', 16, 16, 2));
	...
	function save_record($db){		
		...
		$potencia_kw				= $this->dws['dw_producto_web']->get_item(0, 'POTENCIA_KW');
		...
		$usa_foto_antigua			= $this->dws['dw_producto_web']->get_item(0, 'USA_FOTO_ANTIGUA');
		//$usa_foto_nueva				= $this->dws['dw_producto_web']->get_item(0, 'USA_FOTO_NUEVA');
